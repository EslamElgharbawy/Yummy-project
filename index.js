...
closeNav()
$(".sideNave i.open-close-icon").click(() => {
...
function showSearchInputs() {
    Search.innerHTML = ` <div class="row py-4 g-3">
    <div class="col-12 col-md-6">
        <input onkeyup="searchByName(this.value)" type="text" 
               class="text-white form-control bg-transparent" 
               placeholder="Search By Name" 
               aria-label="First name">
    </div>
    <div class="col-12 col-md-6">
        <input onkeyup="searchByFLetter(this.value)" maxlength="1" type="text" 
               class="text-white form-control bg-transparent" 
...
function displayDetailmeals(meal) {
    ...
    <div class="row g-4">
        ...
        <div class="col-12 col-md-8 text-white">
            ...
            <h3><span class="fw-bolder">Recipes :</h3>
